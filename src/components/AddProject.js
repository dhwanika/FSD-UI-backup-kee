...
this.setState({
    ...
    managerChange=(event)=>{
        this.setState({
         ...
         <button type="button" className="btn btn-primary" onClick={() => {this.deleteProject(project)}}>Suspend</button>
            </div>
              </div>
              </div>
            )}
...
return (
    ...
    <div className="col-md-3">
    <button type="button" className="btn btn-primary" disabled={this.state.disableManagerSearch} onClick={() =>{this.findManager(this.state.manager)}}>Search</button>
    </div>
    </div>
    <div className="row paddingTop10px">
      <div className="col-md-1">
    ...
    <div className="col-md-1">
    <button type="button" className="btn btn-primary" onClick={()=>{this.addproject()}}>Add</button>
  </div>}
